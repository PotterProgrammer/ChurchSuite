...
function saveVolunteerInfo( volunteer, callback)
{
	...
	//
	var ws;
	var url = 'ws://' + window.location.host + '/scheduler/saveVolunteerInfo';
	if ( window.location.protocol == 'https:')
	{
		url = 'wss://' + window.location.host + '/scheduler/saveVolunteerInfo';
	}
...
function showHelp()
{
	window.open( "/scheduler/usermanual.pdf");
}
